...
urlpatterns = [
    path(
        "site-configs/",
        views.SiteConfigurationListCreate.as_view(),
        name="site_configs",
    ),
    path(
        "site-configs/<int:pk>/",
        views.SiteConfigurationDetail.as_view(),
        name="site_config_detail",
    ),
    path(
        "faq-categories/", views.FAQCategoryListCreate.as_view(), name="faq_categories"
    ),
    path(
        "faq-categories/<int:pk>/",
        views.FAQCategoryDetail.as_view(),
    ...
    path(
        "team-members/<int:pk>/",
        views.TeamMemberDetail.as_view(),
        name="team_member_detail",
    ),
    path("testimonials/", views.TestimonialListCreate.as_view(), name="testimonials"),
    path(
        "testimonials/<int:pk>/",
        views.TestimonialDetail.as_view(),
        name="testimonial_detail",
    ),
    path(
        "image-galleries/",
        views.ImageGalleryListCreate.as_view(),
        name="image_galleries",
    ),
    path(
        "image-galleries/<int:pk>/",
        views.ImageGalleryDetail.as_view(),
        name="image_gallery_detail",
    ),
    path(
        "video-galleries/",
        views.VideoGalleryListCreate.as_view(),
        name="video_galleries",
    ),
    path(
        "video-galleries/<int:pk>/",
        views.VideoGalleryDetail.as_view(),
    ...
    path(
        "form-data/",
        views.FormDataListCreateView.as_view(),
        name="form-data-list-create",
    ),
    path(
        "form-data/<int:pk>/",
        views.FormDataRetrieveUpdateDestroyView.as_view(),
        name="form-data-retrieve-update-destroy",
    ),
